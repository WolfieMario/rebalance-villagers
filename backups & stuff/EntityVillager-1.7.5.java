    ...
    implements IMerchant, NPC
{
    ...
    public EntityVillager(World world, int k)
    {
        ...
        goalSelector.a(1, new PathfinderGoalAvoidPlayer(this, net/minecraft/server/v1_7_R2/EntityZombie, 8F, 0.59999999999999998D, 0.59999999999999998D));
        ...
        goalSelector.a(9, new PathfinderGoalInteract(this, net/minecraft/server/v1_7_R2/EntityHuman, 3F, 1.0F));
        goalSelector.a(9, new PathfinderGoalInteract(this, net/minecraft/server/v1_7_R2/EntityVillager, 5F, 0.02F));
        goalSelector.a(9, new PathfinderGoalRandomStroll(this, 0.59999999999999998D));
        goalSelector.a(10, new PathfinderGoalLookAtPlayer(this, net/minecraft/server/v1_7_R2/EntityInsentient, 8F));
    }
