...
public class ShopkeeperWaiter implements Runnable {
    ...
    private net.minecraft.server.v1_6_R2.World mcWorld;
    ...
    public ShopkeeperWaiter(EntityVillager vil, net.minecraft.server.v1_6_R2.World world, RebalanceVillagers _plugin) {
        villager = vil;
        mcWorld = world;
        plugin = _plugin;
    }
