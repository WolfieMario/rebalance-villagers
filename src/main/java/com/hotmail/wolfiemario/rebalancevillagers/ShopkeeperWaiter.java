...
public class ShopkeeperWaiter implements Runnable {
    ...
    private net.minecraft.server.v1_5_R3.World mcWorld;
    ...
    public ShopkeeperWaiter(EntityVillager vil, net.minecraft.server.v1_5_R3.World world, RebalanceVillagers _plugin) {
        villager = vil;
        mcWorld = world;
        plugin = _plugin;
    }
