 ...
 */
public class BalancedVillager_old extends EntityVillager
	implements NPC, IMerchant
{
     ...
     */
    public BalancedVillager_old(World world)
    {
        this(world, 0);
    }
     ...
     */
    public BalancedVillager_old(World world, int k)
    {
        super(world, k);
...
//    private float bO;
     ...
     */
    public BalancedVillager_old(EntityVillager vil)
    {
        this(vil, false);
    }
        
    public BalancedVillager_old(EntityVillager vil, boolean check) {
