...
public class RebalanceVillagers extends JavaPlugin implements Listener {
    ...
    public void onCreatureSpawn(CreatureSpawnEvent event) {
        ...
        final net.minecraft.server.v1_8_R2.World mcWorld = ((CraftWorld) entity
                .getWorld()).getHandle();
        net.minecraft.server.v1_8_R2.Entity mcEntity = (((CraftEntity) entity)
                .getHandle());
    ...
    private void convertExistingVillagers() {
        ...
        for (World world : worldList) {
            ...
            net.minecraft.server.v1_8_R2.World mcWorld = ((CraftWorld) world)
                    .getHandle();
    ...
    public void convertVillager(EntityVillager vil,
            net.minecraft.server.v1_8_R2.World mcWorld) {
