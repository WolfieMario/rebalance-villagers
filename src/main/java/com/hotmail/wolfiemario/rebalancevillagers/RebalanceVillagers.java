...
public class RebalanceVillagers extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        try {
            ...
            Method entityTypesA = net.minecraft.server.v1_5_R1.EntityTypes.class.getDeclaredMethod("a", Class.class, String.class, int.class);
    ...
    public void onCreatureSpawn(CreatureSpawnEvent event) {
        ...
        net.minecraft.server.v1_5_R1.World mcWorld = ((CraftWorld) entity
                .getWorld()).getHandle();
        net.minecraft.server.v1_5_R1.Entity mcEntity = (((CraftEntity) entity)
                .getHandle());
    ...
    private void convertExistingVillagers() {
        ...
        for (World world : worldList) {
            ...
            net.minecraft.server.v1_5_R1.World mcWorld = ((CraftWorld) world)
                    .getHandle();
    ...
    public void convertVillager(EntityVillager vil,
            net.minecraft.server.v1_5_R1.World mcWorld) {
